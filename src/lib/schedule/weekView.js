...
// (Round-3 NO-LEGACY) `weekShouldHeat` + its `choreHeat` ramp are GONE. The
// continuous should-escalation gradient is superseded by the binary warn/due
// warming model computed in `farmLoad` (F24): a deferrable chore is either DUE
// today or WARNING (due later this week), surfaced by a ClockAlert — no 0..1
// heat. The countdown itself still lives in `choreDaysRemaining` (chores.js).

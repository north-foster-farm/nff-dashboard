LEASE: 2026-08-25T13:37:42Z cloud-run-0120
...
now **614 hours** stale (25.6 days); nothing has touched a PR in
24.3 days.
...
last forty-two runs: the queue stands at twenty-two live against
...
Q13 (CARRIED, still the only thing that matters): will you drain
    ...
    614 hours. #5 shipped LGTM-label auto-merge, so applying `LGTM`

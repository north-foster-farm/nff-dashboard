LEASE: 2026-08-17T01:35:38Z cloud-run-119
...
re-derived in full against every `[batch]` marker in ROADMAP.md nine
...
**Staleness, from the commit timestamps.** `main` is **410 hours**
stale — 17 days 2 hours, measured from `131bce1`. The gap since
anything at all touched a PR is **15.83 days**, from #17. Both are one
...
elapse. The 7-day mark falls at **2026-08-17T12:40Z**, **twelve
...
current cadence that is the run landing around 2026-08-17T12:34Z or
...
comment or a review. Re-verified 08-17T00:35Z against the GitHub API —
...
Q13 (CARRIED, still the only thing that matters): will you drain the
    PR queue? Twelve green PRs, and `main` has not advanced in 410

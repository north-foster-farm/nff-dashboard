LEASE: 2026-08-17T03:35Z cloud-run-121
...
eleven runs ago; nothing on either side has moved since, so I did not
repeat that walk this hour. No notification and no new questions,
both by the standing rules restated below.

**Staleness, from the commit timestamps.** `main` is **412 hours**
stale — 17 days 4 hours, measured from `131bce1`. The gap since
anything at all touched a PR is **15.91 days**, from #17. Both are one
...
elapse. The 7-day mark falls at **2026-08-17T12:40Z**, **ten hours**
...
comment or a review. Re-verified 08-17T02:34Z against the GitHub API —

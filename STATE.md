LEASE: 2026-08-06T15:37:36Z run-2026-08-06T15:37Z
...
Added no questions this run, on purpose — seventeenth run in a row.
...
Q13 (CARRIED, now the only thing that matters): will you drain the PR
    queue? Twelve green PRs, and `main` has not advanced in 159

LEASE: 2026-08-25T12:38:30Z cloud-run-0119
...
now **613 hours** stale (25.5 days); nothing has touched a PR in
24.3 days.
...
question, same call as the last forty-one runs: the queue stands at
...
Q13 (CARRIED, still the only thing that matters): will you drain
    ...
    612 hours. #5 shipped LGTM-label auto-merge, so applying `LGTM`

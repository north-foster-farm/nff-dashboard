LEASE: 2026-08-17T08:35:15Z cloud-run-126
...
open list could not hide: #1–#5 closed on 07-30 as recorded, #6–#17
still open, none merged, labelled, reviewed or commented; newest
...
sixteen runs ago; nothing on either side has moved since, so I did
not repeat that walk this hour. No notification and no new questions,
both by the standing rules restated below.

**Staleness, from the commit timestamps.** `main` is **417 hours**
stale — 17 days 9 hours, measured from `131bce1`. The gap since
anything at all touched a PR is **16.12 days**, from #17. Both are one
...
elapse. The 7-day mark falls at **2026-08-17T12:40Z**, **five hours**
...
current cadence that is the run landing around 2026-08-17T12:39Z, five
runs after this one. That is the next scheduled event on this board;
...
comment or a review. Re-verified 08-17T07:39Z against the GitHub API —
...
Q13 (CARRIED, still the only thing that matters): will you drain the
    PR queue? Twelve green PRs, and `main` has not advanced in 417
